...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOGS_DIR / "007_convert_to_documents.log"),
...
def generate_admissions_section(
    uni_data: Dict, university_name: str = "Unknown University"
) -> List[str]:
...
def convert_to_markdown():
    ...
    for i, uni_data in enumerate(universities):
        try:
            university_name = uni_data.get("university_name", "Unknown University")
